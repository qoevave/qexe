...
Very true! If we want to get more organized, we can create a Javascript object in MaxMSP and script out some functions. Going deeper into some DSP we can also open up a GEN object. Read more about that [here](https://docs.cycling74.com/max8/vignettes/gen_overview).
